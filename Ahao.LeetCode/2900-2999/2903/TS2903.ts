function findIndicesTS(nums: number[], indexDifference: number, valueDifference: number): number[] {
...
function findIndicesTS2(nums: number[], indexDifference: number, valueDifference: number): number[] {
